...
<div class="flex-1 p-5 flex justify-center">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 w-full max-w-lg border border-transparent bg-gradient-to-br from-blue-100 to-indigo-100">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('edit.profile') }}" class="inline-block px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-lg shadow-lg hover:from-blue-600 hover:to-indigo-600 transition duration-300">
                Edit Profil
            </a>
        </div>
    </div>
